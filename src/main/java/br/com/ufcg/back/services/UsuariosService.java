...
public class UsuariosService {
    ...
    public List<TurmaDTO> buscaTodasAsTurmas(String emailUser) {
        ...
        for(Turma turma : usuario.get().getManagedTurma())
            turmas.add(new TurmaDTO(turma.getId(),turma.getName(),turma.getCreationDate(),turma.getEndDate(),turma.getFormationStrategy(),turma.getEndingStrategy(),turma.getCurrentAmountOfGroups(),true,turma.getIntegrantes()));
        for(Turma turma : usuario.get().getMembersTurma())
            turmas.add(new TurmaDTO(turma.getId(),turma.getName(),turma.getCreationDate(),turma.getEndDate(),turma.getFormationStrategy(),turma.getEndingStrategy(),turma.getCurrentAmountOfGroups(),false,turma.getIntegrantes()));
